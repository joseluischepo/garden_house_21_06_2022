...
if(isset($_POST["Idtipo"]) && !empty($_POST["Idtipo"])){
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        // Set parameters
        $param_idtipo = trim($_POST["Idtipo"]);
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger fade in">
                            <input type="hidden" name="Idtipo" value="<?php echo trim($_GET["Idtipo"]); ?>"/>
                            <p>Está seguro que deseas borrar el registro</p><br>
                            <p>
                                <input type="submit" value="Si" class="btn btn-danger">
                                <a href="indexTipo.php" class="btn btn-default">No</a>
                            </p>
                        </div>
                    </form>
                </div>
