...
if(isset($_GET["idca"]) && !empty(trim($_GET["idca"]))){
    ...
    $sql = "SELECT * FROM casa2 WHERE idca = ?";
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <p class="form-control-static"><?php echo $row["sup"]; ?></p>
                    </div>     
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <p class="form-control-static"><?php echo $row["vr"]; ?></p>
                    </div>
                    <div class="form-group">
                        <label>Tipo</label>
                        <p class="form-control-static"><?php echo $row["Idtipo"]; ?></p>
                    </div>
                    <div class="form-group">
                        <label>Pais</label>
                    ...
                    <div class="form-group">
                        ...
                        <p class="form-control-static"><?php echo $row["muni"]; ?></p>
                    </div>
                    <div class="form-group">
                        <label>Localidad</label>
                        <p class="form-control-static"><?php echo $row["loca"]; ?></p>
                    </div>
                    <div class="form-group">
                        <label>Colonia</label>
                        <p class="form-control-static"><?php echo $row["col"]; ?></p>
                    </div>
                    <div class="form-group">
                        <label>Calle</label>
