...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($input_nametipo)){
        $nametipo_err = "Por favor ingrese el nombre del tipo de casa.";
    ...
    if(empty($nametipo_err)){
        ...
        $sql = "INSERT INTO tipo (nametipo) VALUES (?)";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "s", $param_nametipo);
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                header("location: createTipo.php"); //pendiente checar esto
                exit();
            } else{
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        <div class="form-group <?php echo (!empty($nametipo_err)) ? 'has-error' : ''; ?>">
                            ...
                            <input type="text" name="nametipo" class="form-control" value="<?php echo $nametipo; ?>">
                        ...
                        <a href="indexTipo.php" class="btn btn-default">Cancelar</a>
                         ...
                         <p><a href="indexTipo.php" class="btn btn-primary">Volver</a></p>
                    </form>
                </div>
            </div>        
        </div>
