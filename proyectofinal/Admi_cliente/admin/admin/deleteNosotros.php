...
if(isset($_POST["idnosotros"]) && !empty($_POST["idnosotros"])){
    // Include config file
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        // Set parameters
        $param_id = trim($_POST["idnosotros"]);
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Eliminar Nosotros</h1>   
                    </div>
                </main>
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger fade in">
                            <input type="hidden" name="idnosotros" value="<?php echo trim($_GET["idnosotros"]); ?>"/>
                            <p>Está seguro que deseas borrar el registro</p><br>
                            <p>
                                <input type="submit" value="Si" class="btn btn-danger">
                                <a href="indexNosotros.php" class="btn btn-default">No</a>
                            </p>
                        </div>
                    </form>
                </div>
