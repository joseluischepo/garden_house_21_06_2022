...
if(isset($_POST["idc"]) && !empty($_POST["idc"])){
    ...
    $sql = "DELETE FROM cliente WHERE idc = ?";
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger fade in">
                            <input type="hidden" name="idc" value="<?php echo trim($_GET["idc"]); ?>"/>
                            <p>Está seguro que deseas borrar el registro</p><br>
                            <p>
                                <input type="submit" value="Si" class="btn btn-danger">
                                <a href="indexCliente.php" class="btn btn-default">No</a>
                            </p>
                        </div>
                    </form>
                </div>
