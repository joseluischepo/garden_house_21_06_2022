...
<html lang="en">
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-6 mt-lg-5 text-center">
            <h1>¿Listo para comprar una propiedad?</h1>    
          </div>
        </div>
      </div>
    ...
    <br><br>
    <center><h1 class="text-shadow">Propiedades en venta</h1></center>
        ...
        <div class='row' style="padding: 10px">
		      <div class='col-lg-12'>
                ...
                <?php
                  require "conex.php";
                  // Include config file
                  $sql = "SELECT idca, titulo, precio, foto FROM casa2 WHERE vr = 'Venta' AND status = 'publicar'";
...
<!-- PARTE DE PANTALLA DE MENSAJE EN VERDE
            <div class="container">
              <br>
              <div class="alert alert-success">
                pantalla de mensaje... 
                <a href="#" class="badge badge-success">ver</a>
              </div> 
             </div>        
             </div>
-->
