    ...
    <div class="owl-carousel with-dots">
        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-6 mt-lg-5 text-center">
              <h1 class="text-shadow">COMPRA Y VENDE PROPIEDADES</h1>
              <p class="mb-5 text-shadow">La mejor agencia inmobiliaria</p>
              <p><a href="InicioDeSesion.php" target="_blank" class="btn btn-primary px-5 py-3">Empezar</a></p>            
            </div>
          </div>
        </div>      
      </div>   
      <div class="site-blocks-cover overlay overlay-2" style="background-image: url(images/hero_2.jpg);" data-aos="fade" id="home-section">
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-6 mt-lg-5 text-center">
              <h1 class="text-shadow">Encuentre su propiedad perfecta</h1>
              <p class="mb-5 text-shadow">Las mejores propiedades en J&V</p>
              <p><a href="AccederRegistrarme.php" target="_blank" class="btn btn-primary px-5 py-3">Empezar</a></p>             
            </div>
          </div>
        </div> 
      </div>  
...
<br><br>
 <center><h1 class="text-shadow">Propiedades destacadas</h1></center>
 ...
 require "conex.php";
 // Include config file
 $sql = "SELECT idca, titulo, precio, foto FROM casa2 WHERE status = 'publicar'";
